...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('binder_program', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('binder', ['Program'])

        # Changing field 'IntranetUser.program'
        db.alter_column('binder_intranetuser', 'program_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['binder.Program'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'Program'
        db.delete_table('binder_program')
