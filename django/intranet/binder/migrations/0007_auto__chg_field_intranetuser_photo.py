...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IntranetUser.photo'
        db.alter_column('binder_intranetuser', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'IntranetUser.photo'
        raise RuntimeError("Cannot reverse this migration. 'IntranetUser.photo' and its values cannot be restored.")
