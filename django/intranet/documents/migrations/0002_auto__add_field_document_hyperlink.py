...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.hyperlink'
        db.add_column('documents_document', 'hyperlink', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.hyperlink'
        db.delete_column('documents_document', 'hyperlink')
